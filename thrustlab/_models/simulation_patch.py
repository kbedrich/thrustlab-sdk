...
T = TypeVar("T", bound="SimulationPatch")
...
class SimulationPatch:
    ...
    Attributes:
        ...
        name (None | str | Unset):
        plot_config_json (list[SimulationPatchPlotConfigJsonType0Item] | None | Unset):
    """

    is_starred: bool | None | Unset = UNSET
    name: None | str | Unset = UNSET
    plot_config_json: list[SimulationPatchPlotConfigJsonType0Item] | None | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_plot_config_json(data: object) -> list[SimulationPatchPlotConfigJsonType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for plot_config_json_type_0_item_data in _plot_config_json_type_0:
                    plot_config_json_type_0_item = SimulationPatchPlotConfigJsonType0Item.from_dict(
                ...
                pass
            return cast(list[SimulationPatchPlotConfigJsonType0Item] | None | Unset, data)

        plot_config_json = _parse_plot_config_json(d.pop("plot_config_json", UNSET))

        simulation_patch = cls(
            is_starred=is_starred,
            name=name,
            plot_config_json=plot_config_json,
        )

        return simulation_patch
