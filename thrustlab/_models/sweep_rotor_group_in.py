...
T = TypeVar("T", bound="SweepRotorGroupIn")


@_attrs_define
class SweepRotorGroupIn:
    ...
    the shared cooling validator).
        ...
        Attributes:
            ...
            motor_cooling_source (SweepRotorGroupInMotorCoolingSource | Unset): Per-rotor-group motor cooling mode. cowling
                ...
                or direct thermal resistance. Default: SweepRotorGroupInMotorCoolingSource.PROP_EXIT_VELOCITY.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        esc_timing: SweepRotorGroupInEscTiming | Unset
        if isinstance(_esc_timing, Unset):
            esc_timing = UNSET
        else:
            esc_timing = SweepRotorGroupInEscTiming(_esc_timing)

        _esc_type = d.pop("esc_type", UNSET)
        esc_type: SweepRotorGroupInEscType | Unset
        if isinstance(_esc_type, Unset):
            esc_type = UNSET
        else:
            esc_type = SweepRotorGroupInEscType(_esc_type)
        ...
        if isinstance(_motor_cooling_source, Unset):
            ...
            motor_cooling_source = SweepRotorGroupInMotorCoolingSource(_motor_cooling_source)
