...
T = TypeVar("T", bound="SimulationListResponse")
...
class SimulationListResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = SimulationResource.from_dict(data_item_data)
        ...
        return simulation_list_response
