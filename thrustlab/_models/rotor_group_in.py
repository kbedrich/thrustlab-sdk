...
T = TypeVar("T", bound="RotorGroupIn")
...
class RotorGroupIn:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        esc_timing: RotorGroupInEscTiming | Unset
        if isinstance(_esc_timing, Unset):
            esc_timing = UNSET
        else:
            esc_timing = RotorGroupInEscTiming(_esc_timing)

        _esc_type = d.pop("esc_type", UNSET)
        esc_type: RotorGroupInEscType | Unset
        if isinstance(_esc_type, Unset):
            esc_type = UNSET
        else:
            esc_type = RotorGroupInEscType(_esc_type)
        ...
        motor_cooling_source: RotorGroupInMotorCoolingSource | Unset
        if isinstance(_motor_cooling_source, Unset):
            motor_cooling_source = UNSET
        else:
            motor_cooling_source = RotorGroupInMotorCoolingSource(_motor_cooling_source)
